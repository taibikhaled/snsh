...
<thead><th><h6 class="font-weight-bold text-gray-100">Moyenne Admission</h6></th><th><h6  class="font-weight-bold text-gray-100">Moyenne CNEG</h6></th></thead>
<tbody> ';
...
<form  method="POST" action="mod.php" >
     ...
     <label class="font-weight-bold text-gray-100" for="textarea">Moyenne d'Admission</label>
