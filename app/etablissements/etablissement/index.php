      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0"><h3 class="text-center" ><b>Etablissement d’Enseignement Secondaire </h3><h5 class="text-center"> cité 350 Logts côte rouge hussein dey - Alger</b></h5></p>
